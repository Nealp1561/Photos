...
public class AlbumListController {
	...
	private void addAlbum(ActionEvent event) throws IOException {
		...
		loader.setLocation(getClass().getClassLoader().getResource("view/CreateAlbumView.fxml"));
		CreateAlbumController.username = username;
		Pane grid = (Pane)loader.load();
		CreateAlbumController cac = loader.getController();
